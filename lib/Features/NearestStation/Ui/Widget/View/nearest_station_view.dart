...
Icon(Icons.my_location, size: 18.sp, color: AppColor.grey),
],
),
),
...
Padding(
padding: EdgeInsets.fromLTRB(16.w, 8.h, 16.w, bottomNavHeight),
...
Widget _buildList(BuildContext context, List<NearestStationModel> stations) {
...
children: [
Icon(Icons.location_off_outlined, size: 48.sp, color: AppColor.muted),
...
ElevatedButton.icon(
onPressed: () => context.read<NearestStationCubit>().loadNearestStations(),
...
style: TextStyle(color: AppColor.muted, fontSize: 14.sp),
),
],
),
),
